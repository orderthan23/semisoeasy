...
public class HostReserve {
	...
	public HostReserve(int reserveNo, String guestNo, int spaceNo, int officeNo, int hostNo, String spaceName,
			...
			int reserveStatus, Date startDay, Date endDay, Date reserveDate) {
		super();
	...
	public String toString() {
		return "HostReserve [reserveNo=" + reserveNo + ", guestNo=" + guestNo + ", spaceNo=" + spaceNo + ", officeNo="
				...
				+ ", startDay=" + startDay + ", endDay=" + endDay + ", reserveDate=" + reserveDate + "]";
	}
