...
public class RecoverMember implements java.io.Serializable {
	...
	public String toString() {
		return "RecoverMember [rNum=" + rNum + ", userId=" + userId + ", dropReason=" + dropReason + ", email=" + email
				+ ", requestDate=" + requestDate + ", rStatus=" + rStatus + "]";
	}
	public RecoverMember() {

	}
	
	public RecoverMember(int rNum, String userId, String dropReason, String email, Date requestDate, int rStatus) {
		super();
		this.rNum = rNum;
		this.userId = userId;
