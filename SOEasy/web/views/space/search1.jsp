...
<body>
	...
	<section>
		...
		<div class="visual">
			<div 
				style="background-image: url(../../images/area/area22-4.png); display: block; height: 600px; width: 100%; background-repeat : no-repeat; background-size : cover;filter: blur(8px); -webkit-filter: blur(8px);">
			</div>
			<div id="searchResult">
				<p style="text-shadow: 1px 2px 2px #ffffff;"><b style="color:#40a4b6;"><%="코워킹 스페이스" %></b> (으)로 검색한 결과입니다.<br>
				</p>
			</div>
		</div>
		<br>
	...
	<br><br>
	<div class="typeBox">
	<input class="sType" type="button" value="코워킹 스페이스" style="background-color:transparent;  border:0px transparent solid; font-size: 20px; font-weight: bolder;">
	<input class="sType" type="button" value="독립오피스" style="background-color:transparent;  border:0px transparent solid;">
	</div>
