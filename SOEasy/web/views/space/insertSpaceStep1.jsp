...
<body>
	...
	<section>
		<div>
			<h1 style="margin:0 auto">공간 등록</h1>
		</div>
		<form action="<%= request.getContextPath() %> %>/insertSpaceCheck1" method="post">
			<table>
				<tr>
					<td>공간 종류</td>
					<td>
						<select name="kinds">
							<option value="office">독립오피스</option>
							<option value="cowork">코워킹스페이스</option>
						</select>
					</td>
				</tr>
				<tr>
