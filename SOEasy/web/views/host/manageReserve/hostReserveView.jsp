...
<div align="center">
	<form id="hostReserveForm" action="/login/insertReserve.ho" method="post">
		<table>
			...
			<tr>
				<td>예약자명</td>
				<td class="tInfo"><input type="text" class="info" id="name1" name="userName" readonly></td>
			</tr>
			<tr><td></td></tr>
			<tr>
				<td>사용자명</td>
				<td class="tInfo"><input type="text" class="info" id="name2"><br>
				<input type="checkbox" id="reserSame" readonly>예약자와 동일</td>
			</tr>
			<tr>
				<td>연락처</td>
				<td class="tInfo"><input type="tel" class="info" id="tel" name="userPhone" readonly></td>
			</tr>
			<tr>
				<td>이메일</td>
				<td class="tInfo"><input type="email" class="info" id="email" name="userEmail" readonly></td>
			</tr>
			<tr>
				<td class="title">요청사항</td>
				<td colspan="2"><textarea cols="37" rows="10" id="textarea" style="resize:none;" name="requestContent" readonly></textarea></td>
			</tr>
		</table>
		<br>
   		<div align="center">
